...
var GamePlay = /*#__PURE__*/function () {
  ...
  _createClass(GamePlay, [{
    ...
    key: "moveToRandomCell",
    value: function moveToRandomCell(arrLength) {
      var _this2 = this;
      var getRandom = function getRandom() {
        var i = Math.floor(Math.random() * arrLength);
        if (i === _this2.cellIndex && _this2.cellIndex !== undefined) {
          getRandom();
        } else {
          _this2.cellIndex = i;
        }
...
;// CONCATENATED MODULE: ./src/js/Interval.js
...
var Interval = /*#__PURE__*/function () {
  ...
  Interval_createClass(Interval, [{
    key: "intervalInit",
    value: function intervalInit(gamePlay, gameControll) {
      var _this = this;
      this.gamePlay = gamePlay;
      this.gameControll = gameControll;
      this.interval = setInterval(function () {
        _this.gamePlay.moveToRandomCell(_this.gamePlay.cells.length);
        _this.gameControll.losePoint += 1;
        if (_this.gameControll.losePoint >= 5) {
          _this.gamePlay.gameOver.classList.remove('hidden');
          clearInterval(_this.interval);
          _this.gamePlay.cellClickListeners = [];
        }
        _this.gamePlay.losePoint.textContent = _this.gameControll.losePoint;
      }, 1000);
    }
  }, {
    key: "clear",
...
;// CONCATENATED MODULE: ./src/js/GameControll.js
function GameControll_typeof(obj) { "@babel/helpers - typeof"; return GameControll_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, GameControll_typeof(obj); }
...
function GameControll_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function GameControll_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, GameControll_toPropertyKey(descriptor.key), descriptor); } }
function GameControll_createClass(Constructor, protoProps, staticProps) { if (protoProps) GameControll_defineProperties(Constructor.prototype, protoProps); if (staticProps) GameControll_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function GameControll_toPropertyKey(arg) { var key = GameControll_toPrimitive(arg, "string"); return GameControll_typeof(key) === "symbol" ? key : String(key); }
function GameControll_toPrimitive(input, hint) { if (GameControll_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (GameControll_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
/* eslint-disable no-shadow */

var GameControll = /*#__PURE__*/function () {
  function GameControll(gameplay) {
    GameControll_classCallCheck(this, GameControll);
    this.gameplay = gameplay;
  }
  GameControll_createClass(GameControll, [{
    key: "init",
    value: function init(container) {
      ...
      this.gameplay.startBtn.addEventListener('click', function () {
        if (_this.gameplay.currentCell) {
          _this.gameplay.currentCell.classList.remove('goblin');
        }
        _this.gameplay.gameOver.classList.add('hidden');
        _this.losePoint = 0;
        _this.point = 0;
        _this.gameplay.point.textContent = 0;
        _this.gameplay.losePoint.textContent = 0;
        _this.interval.clear();
        var startTimer = new Promise(function (resolve) {
          var a = [3, 2, 1];
          var d = null;
          var _loop = function _loop(i) {
            if (i === 3) {
              d = new Promise(function (resolve) {
                setTimeout(function () {
                  _this.gameplay.cells[4].textContent = a[i];
                  resolve();
                }, i * 1000);
              });
            } else {
        ...
        startTimer.then(function () {
          _this.gameplay.cells[4].textContent = '';
          _this.gameplay.moveToRandomCell(_this.gameplay.cells.length);
          _this.interval.intervalInit(_this.gameplay, _this);
          _this.gameplay.addCellClickListener(function (i) {
            if (_this.gameplay.cellIndex === i) {
              _this.interval.clear();
              _this.gameplay.moveToRandomCell(_this.gameplay.cells.length);
              _this.interval.intervalInit(_this.gameplay, _this);
              _this.point += 1;
              _this.gameplay.point.textContent = _this.point;
            }
          });
        });
      });
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var gameControll = new GameControll(gamePlay);
